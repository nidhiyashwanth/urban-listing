      ...
      <section className='max-w-6xl mx-auto flex justify-center items-center flex-col '>
        ...
        <div className='w-full md:w-[50%] mt-6 px-3 '>
          <form>
            ...
            {/* Email Input */}
            <input type="email" id='email' value={email} disabled={!changeDetail} className=' mb-6 w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition ease-in-out ' />
            <div className='flex justify-between whitespace-nowrap text-sm sn:text-lg mb-6  '>
              <p className='flex items-center '>Do you want to edit the name?
                <span onClick={()=> {
