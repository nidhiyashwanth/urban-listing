...
export default function Listing() {
    ...
    return (
        <main>
            ...
            {shareLinkCopied && (
                <p className='fixed top-[23%] right-[5%] font-semibold border-2 text-gray-600 border-gray-200 rounded-md bg-white z-10 p-2 '>Link Copied!</p>
            )}
            <div className=" m-4 flex flex-col md:flex-row max-w-6xl lg:mx-auto p-4 rounded-lg shadow-lg bg-white  lg:space-x-5 ">
                <div className="w-full">
                    ...
                    <ul className='flex items-center space-x-2 lg:space-x-10 text-sm font-semibold mb-6'>
                        ...
                        <li className=' flex items-center whitespace-nowrap'> <FaBath className='text-lg mr-1'/>
                            {+listing.bathrooms > 1 ? `${listing.bathrooms} Baths` : "1 Bath"}
                        </li>
                        <li className=' flex items-center whitespace-nowrap'> <FaParking className='text-lg mr-1'/>
                            {listing.parking ? "Parking Spot" : "No Parking"}
                        </li>
                        <li className=' flex items-center whitespace-nowrap'> <MdChair className='text-lg mr-1'/>
                ...
                <div className="w-full h-[200px] md:h-[300px] z-10 overflow-x-hidden mt-6 md:mt-0 md:ml-2">
                    <p className='text-red-600 font-semibold'>Map isn't working because I don't have a bank card which restricts me from using GeoCoding API</p>
